...
using blogKlimov.Infrastructure;
using blogKlimov.Infrastructure.Guarantors;

namespace blogKlimov
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BlogDbContext>(options =>
                options.UseNpgsql("Username=postgres;Database=blog;Password=stalklim;Host=localhost"));
